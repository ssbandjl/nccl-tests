...
df.columns = ["size_byte", "count", "type", "time_us", "algbw_GBPS", "busbw", "error", "in_place_time", "in_place_algbw", "in_place_busbw", "in_place_error"]

# xw_test = True
xw_test = False
if xw_test:
  df.columns = ["size_byte", "count", "type", "time_us_xw", "algbw_GBPS_xw", "busbw_xw", "error", "in_place_time", "in_place_algbw", "in_place_busbw", "in_place_error"]
  df_filtered = df[["size_byte", "time_us_xw", "algbw_GBPS_xw", "busbw_xw"]]
else:
  df.columns = ["size_byte", "count", "type", "time_us_cx6", "algbw_GBPS_cx6", "busbw_cx6", "error", "in_place_time", "in_place_algbw", "in_place_busbw", "in_place_error"]
