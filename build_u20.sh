...
make -j32 MPI_HOME=$MPI_HOME CXXFLAGS="-I/usr/lib/x86_64-linux-gnu/openmpi/include -L/usr/lib/x86_64-linux-gnu/openmpi/lib -g -Og" MPI=1 CUDA_HOME=$CUDA_HOME NCCL_HOME=$NCCL_HOME
# make -j32 CXXFLAGS="-I/usr/lib/x86_64-linux-gnu/openmpi/include -L/usr/lib/x86_64-linux-gnu/openmpi/lib -g -Og" MPI=1 CUDA_HOME=/usr/lib/cuda DEBUG=1
